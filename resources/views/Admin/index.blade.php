            ...
            <div class="widget widget-chart-one">
                <div class="widget-heading">
                    ...
                    <ul class="tabs tab-pills">
                        <li>
                            <a href="javascript:void(0);" id="tb_1" class="tabmenu">ماهانه</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="mt-container mx-auto">
                        <div class="timeline-line">
                            ...
                            <div class="item-timeline timeline-success">
                                ...
                                <div class="t-text">
                                    <p>
                                        ارسال نامه به <a href="javascript:void(0);">HR</a> و
                                        <a href="javascript:void(0);">ادمین</a>
                                    </p>
                            ...
                            <div class="item-timeline timeline-dark">
                                ...
                                <div class="t-text">
                                    <p>
                                        جمع آوری اسناد از
                                        <a href="javascript:void(0);">سارا</a>
                                    </p>
                                    <span class="badge badge-success">تکمیل شد</span>
                            ...
                            <div class="item-timeline timeline-warning">
                                ...
                                <div class="t-text">
                                    <p>
                                        تماس کنفرانسی با
                                        <a href="javascript:void(0);">مدیر بازاریابی</a>.
                                    </p>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="td-content customer-name">
                                            <img src="assets/img/90x90.jpg" alt="avatar" />اندی کینگ
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content pricing">
                                            <span class="">88000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="badge outline-badge-primary">حمل شده</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content customer-name">
                                            <img src="assets/img/90x90.jpg" alt="avatar" />ایرین کالینز
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content pricing">
                                            <span class="">840000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="badge outline-badge-success">پرداخت شده</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content customer-name">
                                            <img src="assets/img/90x90.jpg" alt="avatar" />لوری فاکس
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content pricing">
                                            <span class="">1260000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="badge outline-badge-danger">در انتظار</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content customer-name">
                                            <img src="assets/img/90x90.jpg" alt="avatar" />لوک
                                            عاج
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name">
                                            <img src="assets/img/90x90.jpg" alt="avatar" />رایان کالینز
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name">
                                            <img src="assets/img/90x90.jpg" alt="avatar" />نیا
                                            هیلیر
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name">
                                            <img src="assets/img/90x90.jpg" alt="avatar" />سونیا شاو
                                        </div>
                                    </td>
                                    <td>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="td-content product-name">
                                            <img src="assets/img/90x90.jpg" alt="product" />بلندگو
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="pricing">860000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="discount-pricing">10000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content">
                                            <a href="javascript:void(0);" class="">مستقیم</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content product-name">
                                            <img src="assets/img/90x90.jpg" alt="product" />عینک
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="pricing">560000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="discount-pricing">50000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content">
                                            <a href="javascript:void(0);" class="">گوگل</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content product-name">
                                            <img src="assets/img/90x90.jpg" alt="product" />ساعت
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="pricing">88000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="discount-pricing">20000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content">
                                            <a href="javascript:void(0);" class="">تبلیغات</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content product-name">
                                            <img src="assets/img/90x90.jpg" alt="product" />لپتاپ
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="pricing">110000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="discount-pricing">56000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content">
                                            <a href="javascript:void(0);" class="">ایمیل</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content product-name">
                                            <img src="assets/img/90x90.jpg" alt="product" />دوربین
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="pricing">2500000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="discount-pricing">120000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="td-content">
                                            <a href="javascript:void(0);" class="">معرف</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="td-content product-name">
                                            <img src="assets/img/90x90.jpg" alt="product" />کفش
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="pricing">1180000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="discount-pricing">460000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name">
                                            <img src="assets/img/90x90.jpg" alt="product" />هدفون
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="pricing">1680000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="td-content">
                                            <span class="discount-pricing">560000 تومان</span>
                                        </div>
                                    </td>
                                    <td>
